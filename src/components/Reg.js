        ...
        <div className='flex min-h-screen px-4'>
            <div className='w-full md:w-1/2 bg-[#FAFAFC] py-[70px] flex justify-center items-center'>
                <div className='sm:w-[400px]'>
                    ...
                    <div className='mt-8'>
                        <div>
                            <p className='text-[14px] font-medium leading-[20px] text-[#374151]'>Full Name</p>
                            <div className='border rounded-md w-full'>
                                <input type="text"  className='w-full outline-none h-[36px] rounded-md px-3 placeholder:font-normal' placeholder='Full Name'/>
                            </div>
                        </div>
                        <div className='mt-6'>
                        ...
                        <button className='text-center h-[52px] rounded-md border mt-6 w-full bg-[#535CEA] text-white'>Create Account</button>
                    </div>
            ...
            <div className='w-1/2 bg-[#4A55ED] hidden md:flex items-center justify-center'>
                <div>
