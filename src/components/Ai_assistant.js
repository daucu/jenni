  ...
  return (
    <div className='px-4 pt-[80px]'>
        <div className='max-w-[1250px] m-auto'>
            ...
            <p className='text-[38px] leading-[46px] sm:text-[46px] sm:leading-[51px] text-[#0a001f] font-extrabold text-center mt-6'>Never write alone</p>
            <div className='flex justify-center'>
                <p className='text-[#555] text-[16px] leading-[22px] sm:text-[22px] sm:leading-[31px] text-center mt-3'>Get suggestions whenever you are stuck or expand your notes into full paragraphs</p>
            </div>
            ...
            <img src={ai_assistant} alt="" className='lg:max-w-[900px] mx-auto mt-10'/>
        </div>
    </div>
  )
}
