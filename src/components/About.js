  ...
  return (
    <div>
        ...
        <div className='px-4 pt-[150px]'>
          ...
          <div className='text-[25px] leading-[30px] sm:text-[57px] sm:leading-[63px] font-extrabold max-w-[1050px] mx-auto text-[#0a001f] my-[70px]'><p className='max-w-[900px]'>Our Team</p></div>
          <div className='flex flex-wrap my-10 max-w-[1100px] mx-auto'>
                <div className='w-full sm:w-1/2 p-2'>
